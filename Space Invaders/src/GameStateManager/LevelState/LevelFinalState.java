 ...
 * @author pearl
 */
public class LevelFinalState extends LevelState{
    
    public LevelFinalState(GameStateManager gsm) {
	...
	public void setupEnemies() {
        ...
        int enemy1_row_size = 3; 
        int enemy2_row_size = 2;
        int enemy3_row_size = 2;
